...
class TestEM:
    ...
    def test_em_deterministic(self, pipeline_data):
        ...
        np.random.seed(ts.get_random_seed())
        tl1 = TelescopeLikelihood(ts.raw_scores, opts)
...
class TestDecomposition:
    def test_multiple_components(self, pipeline_data):
        ...
        from telescope.utils.decompose import find_blocks
...
class TestReportGeneration:
    def test_output_files_created(self, pipeline_data):
        ...
        from telescope.utils.model import TelescopeLikelihood
        from telescope.utils.reporter import output_report
