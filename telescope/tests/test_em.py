# -*- coding: utf-8 -*-
"""Tests for TelescopeLikelihood EM algorithm and full pipeline baseline.

Tests cover:
- TelescopeLikelihood initialization from sparse matrix
...
# --- Mock opts for TelescopeLikelihood ---

class MockOpts:
    """Minimal options object for TelescopeLikelihood."""
...
def simple_tl(simple_scores, simple_opts):
    return TelescopeLikelihood(simple_scores, simple_opts)


# --- TelescopeLikelihood initialization ---

class TestTelescopeLikelihoodInit:
...
class TestReassignment:
    ...
    def setup_tl(self, simple_scores, simple_opts):
        self.tl = TelescopeLikelihood(simple_scores, simple_opts)
        self.tl.em()
...
class TestBaselineEquivalence:
    ...
    def setup_pipeline(self):
        ...
        np.random.seed(seed)
        self.tl = TelescopeLikelihood(ts.raw_scores, opts)
